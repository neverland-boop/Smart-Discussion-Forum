    ...
    <div class="flex h-screen bg-slate-800 overflow-hidden">
        ...
        @if(!request()->routeIs('quiz.attempt'))
            ...
            <aside
                ...
                class="fixed inset-y-0 left-0 z-50 w-64 h-full bg-slate-900 border-r border-slate-700 flex flex-col justify-between shrink-0 shadow-2xl transform transition-transform duration-200 ease-out lg:static lg:translate-x-0 lg:shadow-none">
                <div>
                    <div class="h-16 flex items-center justify-between px-6 border-b border-brand-strong">
                ...
                <!-- Profile Dropdown -->
                <div class="p-6 border-t border-brand-strong">
